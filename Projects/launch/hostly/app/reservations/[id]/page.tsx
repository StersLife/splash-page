...
import DynamicUpsells from '@/components/dynamic-upsells'
import UpsellTestingTool from '@/components/upsell-testing-tool'
...
<div className="mt-6">
        <h3 className="text-xl font-semibold mb-4">Rule Debugger Tool</h3>
        <RuleDebugger />
      </div>
    </div>
  )
